              ...
              <ul className="space-y-5">
                ...
                <li>
                  ...
                  >
                    ...
                    />
                    <a
                      href="https://wa.me/201067032423"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-[var(--grey-dark)] hover:text-[var(--color-darker)] transition-colors focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]"
                    >
                      +20 10 67032423 — {t("generalContact.whatsappInquiries")}
                    </a>
                  </motion.div>
                </li>
                {/* WhatsApp for Orders */}
                <li>
                  ...
                  >
                    ...
                    />
                    <a
                      href="https://wa.me/201016997477"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-[var(--grey-dark)] hover:text-[var(--color-darker)] transition-colors focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]"
                    >
                      +20 10 16997477 — {t("generalContact.whatsappOrders")}
                    </a>
                  </motion.div>
                </li>
                <li>
